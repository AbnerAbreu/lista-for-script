...
let acessos = [
    {email:"abnerdrift@gmail.com",senha:12344},
    {email:"toshiro@gmail.com",senha:3666},
    {email:"camara@gmai.com",senha:39193767}
]


function validarLogin(){
    for(let acesso of acessos){
    if(inputEmail.value == acesso.email && inputSenha.value == acesso.senha){
